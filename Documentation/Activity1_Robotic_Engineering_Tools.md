...
**Activity Student1:** Roc Ferrer Novoa

| ![](./Images/code_RocFerrer.png) | ![](./Images/pick_RocFerrer.png) |
|:----------------------------:|:--------------------------------------:|
| *a) VScode*                 | *b) roboDK Pick cube*                 |

**Activity Student 2:** Roger Panadès

| ![](./Images/code_RogerPanades.png) | ![](./Images/pick_RogerPanades.png) |
|:----------------------------:|:--------------------------------------:|
| *a) VScode*                 | *b) roboDK Pick cube*                 |

**Activity Student 2:** Maite Boelen

| ![](./Images/sync_maite.png) | ![](./Images/pick_maite.png) |
|:----------------------------:|:--------------------------------------:|
| *a) VScode*                 | *b) roboDK Pick cube*                 |
